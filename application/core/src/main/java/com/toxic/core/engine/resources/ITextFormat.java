...
public interface ITextFormat {
   ...
   * 
   * @param top
   *          margin for top of bind element
   * @param right
   *          margin for right of bind element
   * @param bottom
   *          margin for bottom of bind element
   * @param left
   *          margin for left of bind element
   */
   ...
   * 
   * @param horizontal
   *          margin for top and bottom of bind element
   * @param vertical
   *          margin for right and left of bind element
   */
